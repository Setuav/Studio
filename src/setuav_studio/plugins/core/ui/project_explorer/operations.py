...
if TYPE_CHECKING:
    from setuav_studio.plugins.core.ui.project_explorer.tree import ProjectExplorer
...
class ProjectExplorerOperations:
    ...
    def add_parameter_action(self, is_constant: bool = False, parent: QWidget | None = None) -> None:
        from setuav_studio.plugins.core.ui.project_explorer.dialog_actions import (
