...
sys.modules["setuav_studio.plugins.geometry.lifting_surface_geometry"] = engine.lifting_surface_geometry
...
sys.modules["setuav_studio.plugins.geometry.fuselage_section_dialog"] = editors.fuselage_section_dialog
